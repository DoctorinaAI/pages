...
const locale: LocaleModule = {
  ...
  ` : `
    ...
    <p>3.3. Parte del contenido, incluidas las sugerencias relacionadas con la salud, puede ser generado mediante tecnologías de aprendizaje automático e inteligencia artificial, ya sea desarrolladas por terceros o por nosotros. Doctorina no ofrece garantías, explícitas ni implícitas, respecto a la precisión, integridad o fiabilidad de dicho contenido, incluyendo garantías implícitas de idoneidad para un propósito específico o de no infracción. Toda la información generada por IA debe ser verificada de forma independiente con profesionales sanitarios calificados antes de ser utilizada como base de decisiones.</p>

    <p>3.4. Como norma general, el mayor valor de los Servicios se obtiene cuando proporcionas información lo más precisa y completa posible sobre lo que deseas consultar. Eres responsable de que el contenido que ingreses, tal como se define más adelante, cumpla con estos estándares.</p>

    <h2>4. REGISTRO Y ELEGIBILIDAD</h2>

    <p>4.1. Para utilizar la App, puede que se te solicite crear una cuenta ("Cuenta") y proporcionar cierta información personal, la cual puede incluir tu nombre y dirección de correo electrónico. Deberás aceptar los términos de uso y la política de privacidad al descargar la App.</p>

    <p>4.2. Debes tener la mayoría de edad legal (al menos 18 años) para registrarte y utilizar nuestros Servicios. Al utilizar nuestros Servicios, confirmas que tienes la edad legal requerida.</p>

    <p>4.3. Si en algún momento detectamos o sospechamos que un perfil pertenece a un menor de edad, nos reservamos el derecho de solicitar pruebas que acrediten tu edad legal. Si no proporcionas pruebas suficientes, procederemos a la terminación inmediata de tu Cuenta y la eliminación de tus datos.</p>

    <p>4.4. No debes utilizar una Cuenta que pertenezca a otra persona. Cada individuo puede tener una sola Cuenta. Debes proporcionarnos información de registro precisa, completa y actualizada. Eres responsable de mantener la confidencialidad de tu contraseña o de las credenciales utilizadas si decides iniciar sesión a través de una plataforma de terceros (por ejemplo, una cuenta de Google). El incumplimiento de esta disposición puede resultar en la terminación inmediata de tu Cuenta. Nos reservamos el derecho de rechazar el registro de cualquier persona o cancelar un registro a nuestra entera discreción.</p>
    ...
    <p>5.6. Sin perjuicio de lo anterior, nos reservamos el derecho de cancelar, retirar o no publicar, en cualquier momento y sin previo aviso, cualquier Contenido del Usuario que consideremos, a nuestra entera discreción, inapropiado o que infrinja este Acuerdo, la ley o los derechos de terceros.</p>
    ...
    <p>5.8. Además, aunque no tenemos la obligación de revisar, editar o supervisar el Contenido del Usuario, podemos eliminar o remover dicho contenido en cualquier momento y por cualquier motivo.</p>
    ...
    <p>6.4. Eres el único responsable del acceso y uso adecuado de tu Cuenta y del contenido dentro de los Servicios, sujeto a la legislación nacional o internacional, así como a los principios de buena fe, moral, buenas costumbres y orden público.</p>
    ...
    <p>7.2. Declaras y garantizas que (1) no te encuentras ubicado en ningún país o región sujeta a embargo por parte del gobierno, y (2) no figuras en ninguna lista de personas restringidas según las regulaciones mencionadas anteriormente.</p>

    <p>7.3. Aceptas cumplir con todas las leyes y regulaciones de exportación para asegurar que ni los Servicios ni ningún dato técnico relacionado, ni ningún producto directo o productos derivados de dicha tecnología que recibas bajo este Acuerdo sean exportados o reexportados, directa o indirectamente, en violación de dichas leyes y regulaciones o para fines prohibidos por las mismas.</p>

    <h2>8. SERVICIOS DE PAGO Y SUSCRIPCIONES</h2>

    <p>8.1. Aunque los Servicios se ofrecen en modalidad "beta", algunos pueden ser de pago: por ejemplo, podemos ofrecerte una suscripción o una compra puntual. El precio de cada producto se indicará en la pantalla de pago o en otras secciones de la plataforma de Servicios.</p>

    <p>8.2. Podemos ofrecerte la opción de adquirir suscripciones que den acceso a ciertos Servicios adicionales. Las suscripciones tienen una duración indefinida. Te cobraremos automáticamente tarifas recurrentes de forma periódica hasta que canceles. Antes de comprar, te informaremos sobre las tarifas, la frecuencia de facturación y cómo cancelar.</p>

    <p>8.3. Algunos Servicios incluidos en la suscripción pueden cambiar con el tiempo, a medida que introducimos nuevas funciones, desarrollamos las actuales o retiramos algunas. Las funciones y contenidos pueden variar según el país, el idioma, la tienda correspondiente, la versión o el dispositivo.</p>

    <p>8.4. Podemos modificar ocasionalmente las suscripciones, incluidas las tarifas recurrentes, y te informaremos previamente sobre cualquier cambio de precio. Los nuevos precios entrarán en vigor al inicio del siguiente periodo de suscripción posterior a la notificación. Al continuar utilizando la suscripción después del cambio, se entenderá que aceptas el nuevo precio. Si no estás de acuerdo, puedes rechazarlo cancelando la suscripción antes de que el nuevo precio entre en vigor.</p>

    <p>8.5. Aunque intentamos asegurar que todos los precios en los Servicios sean correctos, pueden ocurrir errores. En tal caso, nos pondremos en contacto contigo. Tendrás derecho a volver a adquirir el Servicio una vez resuelto el error. Si no logramos contactarte, tu compra será cancelada automáticamente.</p>

    <p>8.6. Tu suscripción se renovará automáticamente al final del periodo vigente, a menos que la canceles antes de que termine.</p>

    <p>8.7. Debes cancelar tu suscripción o prueba gratuita antes de su renovación para evitar el cobro del siguiente periodo. Puedes escribirnos a support@doctorina.com o gestionarlo desde la sección "gestionar mi suscripción" dentro de los Servicios.</p>
    ...
    <p>8.9. Podemos enviarte un resumen por correo electrónico sobre la compra realizada, incluyendo descripción, características, duración, precio, método de pago y fecha del contrato. Es posible que no tengas derecho a desistimiento ni a reembolso por esta transacción.</p>
    ...
    <p>8.11. También puedes realizar una donación para el desarrollo de los Servicios gratuitos existentes. En caso de donaciones recurrentes, se aplican los mismos principios de cancelación que para las suscripciones. Puedes cancelar tu donación recurrente en cualquier momento.</p>

    <h2>9. PRIVACIDAD Y USO DE INTELIGENCIA ARTIFICIAL (IA)</h2>

    <p>9.1. Procesaremos tu información personal conforme a las leyes de privacidad aplicables. Consulta más detalles en nuestra Política de Privacidad, la cual forma parte integral de este Acuerdo.</p>
    ...
    <p>9.4. Doctorina utiliza tecnologías de inteligencia artificial únicamente para apoyar funciones informativas generales de salud y recomendaciones de servicios. Las funcionalidades de IA integradas en la plataforma NO SE CLASIFICAN COMO SISTEMAS DE ALTO RIESGO conforme a las leyes y regulaciones aplicables, incluyendo, entre otras, la Ley de Inteligencia Artificial de la Unión Europea y marcos normativos similares. La plataforma no realiza diagnósticos médicos profesionales, ni reemplaza la toma de decisiones clínicas ni intervenciones críticas en salud. Todos los resultados generados por la IA tienen fines exclusivamente informativos y no sustituyen el consejo, diagnóstico o tratamiento médico profesional. RECONOCES Y ACEPTAS QUE EL USO DE LA IA DENTRO DE DOCTORINA ESTÁ LIMITADO A FUNCIONES INFORMATIVAS NO CRÍTICAS, Y QUE TODA DECISIÓN QUE AFECTE TU SALUD O BIENESTAR DEBE SER TOMADA POR PROFESIONALES MÉDICOS CALIFICADOS.</p>

    <h2>10. LICENCIA LIMITADA DE USO DE LOS SERVICIOS</h2>

    <p>10.1. Nuestros Servicios y el texto, gráficos, imágenes, fotografías, videos, ilustraciones, marcas registradas, nombres comerciales, encabezados de página, íconos de botones, scripts, marcas de servicio, logotipos, eslóganes, filtros, filtros generados por los usuarios y otros contenidos incluidos en ellos (en conjunto, el "Contenido del Servicio") son de nuestra propiedad o están licenciados por nosotros y están protegidos por la ley. Salvo que se indique explícitamente en este Acuerdo, los Servicios y nuestros licenciantes se reservan todos los derechos sobre los Servicios y el Contenido del Servicio. Se te otorga una licencia limitada, no exclusiva, intransferible, no sublicenciable y revocable para acceder y utilizar nuestros Servicios y el Contenido del Servicio únicamente para fines personales y no comerciales. Esta licencia está sujeta a este Acuerdo y no incluye ningún derecho para: (a) vender, revender o utilizar comercialmente los Servicios o el Contenido del Servicio; (b) copiar, reproducir, distribuir, ejecutar públicamente o mostrar públicamente el Contenido del Servicio, salvo lo expresamente permitido por nosotros o por nuestros licenciantes; (c) modificar el Contenido del Servicio, eliminar avisos o marcas de derechos de propiedad, o realizar obras derivadas, salvo lo establecido en este Acuerdo; (d) utilizar técnicas de minería de datos, robots u otros métodos similares de recopilación o extracción de datos; o (e) utilizar los Servicios o el Contenido del Servicio de cualquier forma no expresamente autorizada en este Acuerdo. Cualquier uso de los Servicios o del Contenido del Servicio que no esté específicamente autorizado está estrictamente prohibido y revocará la licencia concedida en virtud de este Acuerdo. No debes eliminar, alterar ni ocultar ningún aviso de derechos de autor, marca registrada, marca de servicio u otros derechos de propiedad incorporados o que acompañen al Contenido del Servicio.</p>

    <p>10.2. Todos los derechos, títulos e intereses sobre los Servicios que no se otorguen expresamente en este Acuerdo son reservados por Doctorina. Si deseas utilizar el software, nombre comercial, marca registrada, marca de servicio, logotipo, nombre de dominio y/o cualquier otra forma de identificación o contenido propiedad de Doctorina o bajo su licencia, deberás obtener autorización escrita de Doctorina. Las solicitudes de permiso pueden enviarse a monica.patron@doctorina.com.</p>

    <p>10.3. Para evitar cualquier duda, Doctorina es titular de todos los textos, imágenes, fotografías, audios, videos, datos de ubicación, software, código y demás formas de datos o comunicación que la Compañía cree y ponga a disposición en relación con los Servicios, incluidos —entre otros— las interfaces visuales, funciones interactivas, gráficos, diseño, compilación de Contenido del Usuario y calificaciones agregadas de usuarios, así como todos los demás elementos y componentes de la App, excluyendo el Contenido del Usuario (denominado colectivamente como el "Contenido de la Compañía"). Salvo lo expresamente indicado en este documento, no se te otorgan derechos expresos ni implícitos, y todos los derechos sobre los Servicios y el Contenido de Doctorina permanecen bajo nuestra titularidad.</p>
    ...
    <p>13.1. Eres el único responsable de proporcionar los medios necesarios (incluidos los costos de conexión a Internet) para acceder a los Servicios. Si experimentas alguna dificultad o incidente, puedes informarlo por correo electrónico a support@doctorina.com. Una vez recibido el reporte, lo analizaremos y te daremos instrucciones razonables para resolverlo.</p>

    <p>13.2. Nos reservamos el derecho de suspender o cancelar tu acceso a los Servicios en cualquier momento y sin previo aviso, ya sea por motivos técnicos, de seguridad, mantenimiento, interrupción del suministro eléctrico u otras causas, estén o no especificadas en este Acuerdo.</p>

    <p>13.3. No tenemos la obligación de controlar cómo los usuarios interactúan o utilizan los Servicios, por lo que no garantizamos que su uso se ajuste a este Acuerdo. No estamos obligados a verificar la identidad de los usuarios ni la exactitud, validez, integridad o autenticidad de la información que proporcionan.</p>

    <p>13.4. En la máxima medida permitida por la ley, rechazamos cualquier responsabilidad por daños derivados del uso de los Servicios o de la falta de veracidad, integridad y/o autenticidad de la información que los usuarios proporcionen a otros, incluyendo pero no limitándose a daños por suplantación de identidad.</p>

    <p>13.5. Controlamos y operamos los Servicios desde diferentes ubicaciones y no garantizamos que estén disponibles en todas partes. Es posible que ciertas funciones no estén disponibles en tu ubicación o varíen según la región.</p>

    <p>13.6. LOS SERVICIOS, INCLUIDOS LOS SERVICIOS EN FASE BETA DE DOCTORINA, SE PROPORCIONAN "TAL CUAL", "SEGÚN DISPONIBILIDAD" Y SIN GARANTÍA DE NINGÚN TIPO, EXPRESA O IMPLÍCITA, INCLUIDAS, ENTRE OTRAS, LAS GARANTÍAS IMPLÍCITAS DE COMERCIABILIDAD, ADECUACIÓN PARA UN FIN PARTICULAR, NO INFRACCIÓN O TITULARIDAD. NI LA COMPAÑÍA NI SUS DIRECTIVOS, EMPLEADOS, AGENTES, SOCIOS, PROVEEDORES O REPRESENTANTES GARANTIZAN QUE: (a) LOS SERVICIOS FUNCIONARÁN DE MANERA SEGURA O ESTARÁN DISPONIBLES EN UN MOMENTO O LUGAR ESPECÍFICO; (b) CUALQUIER DEFECTO SERÁ CORREGIDO; (c) EL CONTENIDO ESTÁ LIBRE DE VIRUS U OTROS COMPONENTES DAÑINOS; (d) LOS RESULTADOS OBTENIDOS SATISFARÁN TUS EXPECTATIVAS; (e) LA INFORMACIÓN ES PRECISA, FIABLE O COMPLETA. El uso de los Servicios corre bajo tu propio riesgo. Algunas jurisdicciones no permiten limitaciones a las garantías implícitas, por lo que es posible que las anteriores no se apliquen a ti.</p>

    <p>13.7. EN NINGÚN CASO LA COMPAÑÍA NI NINGUNO DE SUS REPRESENTANTES SERÁ RESPONSABLE DE DAÑOS INDIRECTOS, ESPECIALES, INCIDENTALES, CONSECUENCIALES O PUNITIVOS (INCLUYENDO PÉRDIDA DE USO, DE DATOS O DE BENEFICIOS), YA SEA POR CONTRATO, NEGLIGENCIA U OTRA TEORÍA LEGAL. La responsabilidad total de la Compañía no excederá el monto que hayas pagado por los Servicios, o cien dólares estadounidenses (USD $100) si no has realizado pagos. Nada en este Acuerdo excluye responsabilidad donde la ley no lo permita. Si alguna disposición excede el límite legal permitido, se considerará restringida al máximo permitido.</p>

    <h2>14. LEY APLICABLE Y RESOLUCIÓN DE DISPUTAS</h2>

    <p>14.1. Si resides en un país de la Unión Europea, Reino Unido, Suiza, Noruega o Islandia, los tribunales de la República de Chipre tendrán jurisdicción exclusiva sobre cualquier disputa derivada de este Acuerdo.</p>

    <p>14.2. Si resides en otro país, tú y la Compañía aceptan resolver cualquier controversia mediante arbitraje individual vinculante conforme a las Reglas de Arbitraje del Consumidor de la Asociación Americana de Arbitraje (AAA). Más información en www.adr.org.</p>

    <p>14.3. Si resides en EE. UU., puedes elegir que el arbitraje se realice en tu estado o en Boston, Massachusetts. Si resides fuera de EE. UU., el lugar será determinado por el árbitro. Las audiencias pueden realizarse por videollamada o resolverse mediante documentos si ambas partes lo acuerdan. La Ley Federal de Arbitraje regirá los procedimientos en EE. UU.</p>

    <p>14.3.1. Antes de iniciar el arbitraje, debes enviar un Aviso de Disputa a 13 Myrtiotissis Street, AQUA MANSIONS, Apartment/Office 1 Germasogeia, 4041, Limassol, Cyprus. La Compañía hará lo mismo a tu correo electrónico. Si no se resuelve en 30 días, cualquiera podrá iniciar el proceso formal.</p>
    ...
    <p>14.3.5. Si la Compañía cambia esta cláusula y tú no estás de acuerdo, puedes rechazar el cambio notificándonos por escrito dentro de los 30 días posteriores a la entrada en vigor del cambio.</p>
    ...
    <p>15.1. Al utilizar los Servicios, aceptas recibir comunicaciones electrónicas (respuestas a solicitudes, notificaciones, promociones, alertas de seguridad, etc.), ya sea por correo electrónico, notificación push o publicaciones en los Servicios.</p>

    <h2>16. TERMINACIÓN</h2>

    <p>16.1. Podemos suspender o cancelar tu Cuenta: (i) si incumples este Acuerdo; (ii) si dejamos de ofrecer los Servicios; (iii) si estás inactivo más de 6 meses; (iv) o sin causa, en cualquier momento.</p>

    <p>16.2. En caso de terminación, deberás dejar de usar los Servicios. Tu acceso a la Cuenta y su contenido podrá ser revocado y eliminado.</p>

    <p>16.3. Al terminar este Acuerdo, seguirán vigentes todas aquellas cláusulas que por su naturaleza deban sobrevivir, como resolución de disputas, propiedad intelectual, exclusión de garantías y limitación de responsabilidad.</p>
    ...
    <p>18.1. Si consideras que algún contenido disponible a través de los Servicios infringe tus derechos de autor, puedes solicitar su eliminación contactándonos con la siguiente información:</p>
